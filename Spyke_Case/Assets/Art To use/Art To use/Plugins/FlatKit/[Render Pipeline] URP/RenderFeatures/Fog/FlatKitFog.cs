...
// Artık eski kod kullanılmadığı için bu uyarıyı gizlemeye gerek yok.
...
public class FlatKitFog : ScriptableRendererFeature {
    class EffectPass : ScriptableRenderPass {
        ...
        public EffectPass(Material effectMaterial) {
            ...
            _temporaryColorTextureID = Shader.PropertyToID("_TemporaryFogTexture");
        }
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) {
            ...
            using (new ProfilingScope(cmd, _profilingSampler)) {
                ...
                if (_destination == null) {
                    ...
                    cmd.Blit(cameraTargetHandle, _temporaryColorTextureID, _effectMaterial);
